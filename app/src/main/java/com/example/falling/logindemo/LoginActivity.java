...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //如果账号已经自动填充，则表焦点放在password的输入框里。
        if(!TextUtils.equals(mEmailView.getText().toString(),"")){
    ...
    private void addEmailsToAutoComplete() {
        List<String> emailAddressCollection =  mLoginUtils.getHistoryAll();
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivity.this,
                        android.R.layout.simple_dropdown_item_1line, emailAddressCollection);
        mEmailView.setAdapter(adapter);
        mEmailView.setText(mLoginUtils.getLastLoginUserName());
    }
